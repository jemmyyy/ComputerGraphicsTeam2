...
dropdown.addEventListener("change", function () {
  ...
  if (this.value === "Volume Rendering example") {
    const controlPanel = `
        <table>
          <tbody>
              <tr>
                <td>Iso value</td>
                <td> <input class="isoValue" type="range" min="0" max="3926" step="0.05" value="1308.6666666666667"> </td>
              </tr>
          </tbody>
        </table>
    `;
  ...
  if (this.value === "Volume Cropping example") {
    // ----------------------------------------------------------------------------
